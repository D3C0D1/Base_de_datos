...
-- Eventos
--
CREATE  EVENT `deshabilitar_ventas_nocturnas` ON SCHEDULE EVERY 1 DAY STARTS '2024-11-07 21:00:00' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE configuracion SET ventas_habilitadas = FALSE WHERE id=1$$

CREATE  EVENT `habilitar_ventas_diurnas` ON SCHEDULE EVERY 1 DAY STARTS '2024-11-07 07:00:00' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE configuracion SET ventas_habilitadas = TRUE WHERE id=1$$
